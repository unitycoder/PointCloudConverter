...
namespace PointCloudConverter
{
    public static class Tools
    {
        ...
        public static void PrintHelpAndExit(char argSeparator, bool waitEnter = false)
        {
            ...
            Console.WriteLine("-skip" + argSeparator + "0\t\t\tSkip every Nth point\tDefault is off");
            Console.WriteLine("-keep" + argSeparator + "0\t\t\tKeep only every Nth point\tDefault is off");
            Console.WriteLine("-maxfiles" + argSeparator + "10\t\t\tFor batch processing, parse only this many files\tDefault is parse all found files");
